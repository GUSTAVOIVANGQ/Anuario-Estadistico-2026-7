"""Figura B.3: servicios de telecomunicaciones por hogar, ámbito urbano."""
...
DOMAIN = "U"
TITLE = "Distribución de los Servicios Fijos con respecto del total de hogares en las zonas urbanas"
...
def generate(context):
    print("  B.3 | Adquisición o reutilización del ZIP ENDUTIH 2025")
    raw_path = context.acquire_source(SOURCE_ID)
    print("  B.3 | Lectura de hogares urbanos y cálculo ponderado de combinaciones")
    ...
    context.record_calculation("total_hogares", "suma(FAC_HOG)", {"dominio": "U"},
