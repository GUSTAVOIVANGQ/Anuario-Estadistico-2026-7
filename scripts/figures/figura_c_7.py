...
<<<<<<< HEAD
    ...
    fig.text(
        bx + bw / 2, by + bh * 0.37, f"{meta['nacional']:.0f}",
    ...
    fig.text(0.093, 0.94, "Figura C.7.", fontsize=14, fontweight="bold", color=TEXT, va="center")
    fig.text(0.170, 0.94, f"Líneas del servicio móvil de telefonía por cada 100 habitantes ({meta['anio']})",
    ...
    fig.text(0.11, 0.07, f"CRT con datos de los operadores de telecomunicaciones a diciembre de {meta['anio']}.",
             fontsize=8, color=TEXT, ha="left", va="center")
    fig.text(0.08, 0.045, "Nota:", fontsize=8, fontweight="bold", color=TEXT, ha="left", va="center")
    fig.text(0.105, 0.045, "El indicador nacional proviene de la serie nacional publicada por el CRT.",
             fontsize=8, color=TEXT, ha="left", va="center")
