"""Figura F.1.2: actividades realizadas en Internet, por sexo."""
...
FIGURE_ID = "F.1.2"
CURRENT_SOURCE_ID = "inegi_endutih_2025"
PERIOD_CURRENT = "2025"
LATEST_SOURCE_ID = ""
PERIOD_LATEST = "2025"
TABLE_TOKEN = "usuarios_anual"
REPORT_TITLE = "Actividades realizadas en Internet"
SUMMARY_TITLE = "Usuarios de Internet"
UNIVERSE = "P7_1"
HIGHLIGHT = ("Audiovisuales gratuitos (YouTube)", "P7_13_3")
METRICS = [
    ("Escuchar música gratis", "P7_13_4", 52, 55),
    ("Audiovisuales de pago", "P7_13_2", 43, 46),
    ("Leer periódicos, revistas o libros", "P7_13_1", 38, 36),
    ("Compras por Internet", "P7_21", 32, 35),
    ("Interacción con el gobierno", ("P7_35_1", "P7_35_2", "P7_35_3", "P7_35_4", "P7_35_5"), 32, 34),
    ("Jugar en línea", "P7_13_5", 21, 34),
    ("Pagos por Internet", "P7_28", 27, 32),
    ("Uso de banca electrónica", "P7_33", 15, 18),
    ("TV en web", "P7_13_7", 12, 15),
    ("Ventas por Internet", "P7_19", 12, 11),
    ("Radio AM y FM", "P7_13_6", 8, 9),
]
REFERENCE_SUMMARY = {"mujeres": 51_036_364, "hombres": 45_975_725, "mujeres_pct": 81, "hombres_pct": 81}
REFERENCE_HIGHLIGHT = (69, 74)
STRICT_SUMMARY = True
REFERENCE_TOLERANCE_PP = 1
REFERENCE_STATUS = "REPRODUCIDA; radio presenta 1 pp de diferencia frente a la lámina"
GRID_ROW_COUNTS = (6, 5)
PANEL_COLOR = "blue"
NOTE = "Todos los usuarios se refieren a personas de 6 años o más. Los porcentajes usan como denominador a usuarios de Internet."
