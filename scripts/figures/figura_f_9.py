...
FIGURE_ID="F.9";CURRENT_SOURCE_ID="inegi_mociba_2025";REFERENCE_SOURCE_ID="inegi_mociba_2024_reference";PERIOD="2025";LANDING_PAGE="https://www.inegi.org.mx/programas/mociba/2025/";TEXT="#50517F";BLUE="#2F7C9F";ACCENT="#F58F82";BG="#FBFBF7"
...
def _plot(data:pd.DataFrame,output:Path,root:Path)->None:
    ...
    for bar,value in zip(bars,data.porcentaje):ax.text(value+.5,bar.get_y()+bar.get_height()/2,f"{value:.1f}%",va="center",fontsize=8.5,fontweight="bold",color=TEXT,bbox=dict(boxstyle="round,pad=.25",fc="white",ec="none"))
