"""Figura F.1.4: uso de redes sociales, por sexo."""
...
REPORT_TITLE = "Redes sociales"
SUMMARY_TITLE = "Usuarios de redes sociales"
UNIVERSE = "P7_15"
HIGHLIGHT = ("WhatsApp", "P7_16_6")
METRICS = [
    ("Facebook", "P7_16_1", 80, 79),
    ("YouTube", "P7_16_7", 37, 40),
    ("Instagram", "P7_16_3", 36, 34),
    ("Messenger", "P7_16_9", 28, 30),
    ("TikTok", "P7_16_10", 27, 22),
    ("X (antes Twitter)", "P7_16_2", 9, 13),
    ("Snapchat", "P7_16_5", 4, 3),
    ("Pinterest", "P7_16_8", 4, 2),
    ("LinkedIn", "P7_16_4", 1, 1),
]
REFERENCE_SUMMARY = {"mujeres": 47_228_697, "hombres": 41_559_860, "mujeres_pct": 75, "hombres_pct": 73}
REFERENCE_HIGHLIGHT = (93, 92)
STRICT_SUMMARY = True
REFERENCE_TOLERANCE_PP = 0
REFERENCE_STATUS = "REPRODUCIDA_EXACTAMENTE"
GRID_ROW_COUNTS = (4, 5)
PANEL_COLOR = "blue"
NOTE = "Todos los usuarios se refieren a personas de 6 años o más. Los porcentajes usan como denominador a usuarios de redes sociales."
