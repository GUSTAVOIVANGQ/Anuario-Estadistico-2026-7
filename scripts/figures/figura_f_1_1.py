"""Figura F.1.1: aplicaciones instaladas mediante Smartphone, por sexo."""
...
LATEST_SOURCE_ID = ""
PERIOD_LATEST = "2025"
TABLE_TOKEN = "usuarios2_anual"
REPORT_TITLE = "Aplicaciones instaladas mediante Smartphone"
SUMMARY_TITLE = "Usuarios de Internet mediante Smartphone"
UNIVERSE = "P8_11"
HIGHLIGHT = ("Instalaron aplicaciones", "P8_14")
METRICS = [
    ("Mensajería instantánea", "P8_16_1", 26, 29),
    ("Acceder a redes sociales", "P8_16_6", 24, 26),
    ("Contenidos de audio y video", "P8_16_2", 22, 26),
    ("Jugar", "P8_16_5", 16, 24),
    ("Tránsito y navegación asistida", "P8_16_4", 12, 16),
    ("Adquirir bienes o servicios", "P8_16_3", 14, 17),
    ("Acceder a banca móvil", "P8_16_7", 12, 15),
    ("Editar fotos o videos", "P8_16_8", 14, 13),
]
REFERENCE_SUMMARY = {"mujeres": 47_113_320, "hombres": 41_676_110, "mujeres_pct": 75, "hombres_pct": 73}
REFERENCE_HIGHLIGHT = (43, 49)
STRICT_SUMMARY = False
REFERENCE_TOLERANCE_PP = 1
REFERENCE_STATUS = "MODELO_OFICIAL_CORREGIDO; la lámina 2024 no coincide plenamente con los microdatos"
GRID_ROW_COUNTS = (4, 4)
PANEL_COLOR = "pink"
NOTE = "Todos los usuarios se refieren a personas de 6 años o más. Cálculos ponderados con FAC_PER."
